  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent
        ...
        side="right"
        className="w-full sm:max-w-md bg-[#0B0D0E] border-emerald-500/20 text-slate-100 overflow-y-auto"
      >
        <SheetHeader>
          <SheetTitle className="font-display text-2xl text-emerald-50 tracking-widest">
            Reader Settings
          </SheetTitle>
          <div className="font-label text-[10px] text-emerald-400">Sculpt your reading pane</div>
        </SheetHeader>
              ...
              return (
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="font-body-serif text-sm text-emerald-50">{t.name}</div>
                ...
                <button
                  ...
                  className={`border p-3 rounded-sm transition-colors ${
                    active
                      ...
                      : "border-emerald-500/10 hover:border-emerald-500/40 text-slate-300"
                  }`}
                >
        ...
        <section className="mt-8">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="font-body-mono text-xs text-emerald-300">{settings.fontSize}px</div>
          </div>
        ...
        <section className="mt-8">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="font-body-mono text-xs text-emerald-300">{settings.lineHeight.toFixed(2)}</div>
          </div>
          <Slider
        ...
        <section className="mt-8">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="font-body-mono text-xs text-emerald-300">{settings.letterSpacing.toFixed(3)}em</div>
          </div>
          <Slider
        ...
        {/* Reset */}
        <section className="mt-10 pt-6 border-t border-emerald-500/10">
          <Button
            ...
            className="text-slate-400 hover:text-emerald-200 font-label text-xs tracking-widest"
          >
